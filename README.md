...
The only required environment variable for train mode is the OpenLDBWS `apiKey`. Optional ADS-B / Plane-Alert aircraft modes and all other settings are documented in [Configuration](/docs/04-configuration.md).
